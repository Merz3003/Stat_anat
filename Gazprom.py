...
revenue = np.array([7970069946000, 11674000000000, 5620061583000, 6256625972000])
staff = np.array([479.2, 492.2, 498.1, 501])
...
plt.title("Декомпозиция индекса выручки Газпром")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
...
plt.axhline(0, color='black', linewidth=1)
plt.title("Декомпозиция индекса производительности труда Газпром")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
