...
revenue = np.array([8761000000000, 9049000000000, 9163573563000, 10139390400000])
staff = np.array([324.6, 336, 332, 320])
...
plt.title("Декомпозиция индекса выручки")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
...
plt.axhline(0, color='black', linewidth=1)
plt.title("Декомпозиция индекса производительности труда Роснефти")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
