...
revenue = [1888308000000, 2333088493000, 2218771228000, 2100000000000]
staff = [111, 111.4, 111.2, 108.3]
...
plt.title("Декомпозиция индекса выручки Сургутнефтигаз")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
...
plt.axhline(0, color='black', linewidth=1)
plt.title("Декомпозиция индекса производительности труда Сургутнефтигаз")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
