...
revenue = [1265000000000, 1453000000000, 1618000000000, 1800000000000]
staff = [65, 66, 70.2, 71.1]
...
plt.title("Декомпозиция индекса выручки Татнефть")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
...
plt.axhline(0, color='black', linewidth=1)
plt.title("Декомпозиция индекса производительности труда Татнефть")
plt.xlabel("Год")
plt.ylabel("Индекс")
plt.legend()
plt.grid()
